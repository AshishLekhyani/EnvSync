...
const COMMANDS = [
  ...
  },
  {
    ...
    desc: "Lists every environment for a project, with its ID.",
  },
  {
  ...
  },
  {
    ...
    desc: "Compares your local .env against the server without revealing any values — metadata only, so it's safe to run often.",
  },
];
  ...
  return (
    <DocsShell>
      ...
      <p className="mb-xl font-body-lg text-body-lg text-secondary">
        The EnvSync CLI has zero runtime dependencies and every command below is real —
        this list matches the actual command surface, not an aspirational one.
      </p>
